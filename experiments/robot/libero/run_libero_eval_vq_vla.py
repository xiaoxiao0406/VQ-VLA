...
class GenerateConfig:
    ...
    #################################################################################################################
    model_family: str = "vqvla"                    # Model family
    ...
    local_log_dir: str = "./experiments/logs/conv_vqvae_new"        # Local directory for eval logs
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for episode_idx in tqdm.tqdm(range(cfg.num_trials_per_task)):
            ...
            while t < max_steps + cfg.num_steps_wait:
                ...
                # img_save_dir = "./saved_images"
                # os.makedirs(img_save_dir, exist_ok=True)
                # img_save_path = os.path.join(img_save_dir, f"img_{task_episodes+1}_{t}.png")
