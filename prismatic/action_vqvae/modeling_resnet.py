...
class CausalResnetBlock2D(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.conv1 = CausalConv2d(in_channels, out_channels, kernel_size=3, stride=1)
        ...
        self.conv2 = CausalConv2d(out_channels, conv_2d_out_channels, kernel_size=3, stride=1)
        ...
        if self.use_in_shortcut:
            self.conv_shortcut = CausalConv2d(
                in_channels,
